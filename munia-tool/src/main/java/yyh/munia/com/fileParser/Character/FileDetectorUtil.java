 ...
 */
public class FileDetectorUtil
{
//    private static final String SYSTEM_CHARACTOR = System.getProperty("fileParser.encoding");
    /**
     * 检测文件
     * @param inputStream
     * @return
...
//    {
//        return CharactorDector.detect(filePath);
//    }
