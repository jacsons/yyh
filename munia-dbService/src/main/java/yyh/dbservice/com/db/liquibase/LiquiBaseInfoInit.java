 ...
 */
public class LiquiBaseInfoInit implements InitializingBean
{
     ...
     * 该实例
     */
    private static LiquiBaseInfoInit instance;
     ...
     * @return
     */
    public LiquiBaseInfoInit getInstance()
    {
        return instance;
    }
